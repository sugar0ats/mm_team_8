...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, Right_Receiver_Pin|Right_Front_Receiver_Pin);

    HAL_GPIO_DeInit(Left_Front_Receiver_GPIO_Port, Left_Front_Receiver_Pin);

    HAL_GPIO_DeInit(Left_Receiver_GPIO_Port, Left_Receiver_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Left_Encoder_1_Pin|Left_Encoder_2_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Right_Encoder_1_Pin|Right_Encoder_2_Pin);
